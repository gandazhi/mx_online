...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, choices=(('training', u'培训机构'), ('university', u'高校'),
                                                        ('personal', u'个人')), default='training', verbose_name=u'机构类别')
...
class Teacher(models.Model):
    ...
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u'添加时间')
    age = models.IntegerField(verbose_name=u'讲师年龄', default=0)
